...
/*
	wia mocht ma des....
		...
		das sind 3*nt*nturns eintr�ge * 2 weil thread_id auch immer schreiben

		ausserdem... alias? k�nnt ma machen.
					...
					for (int k = j; k > corr_finish; k -= 2)
					{
							...
							&& (event_log[k + 1] == 1))
						{
							...
							if (print_to_console)
							{
								...
								printf("Thread %i doorway start: %i\n",
									other_thread, k);
								...
								//print_array(&event_log[corr_finish],
								//	num_threads * 8,
								//	num_lines);
